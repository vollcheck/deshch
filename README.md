...
* [`src/deshch/`](src/deshch/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/deshch/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `deshch` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/deshch/config.cljs) defaults to `true` in
...
```clj
(ns deshch.example
  (:require [deshch.config :as config])
